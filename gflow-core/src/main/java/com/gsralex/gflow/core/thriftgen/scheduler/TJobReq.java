...
public class TJobReq implements org.apache.thrift.TBase<TJobReq, TJobReq._Fields>, java.io.Serializable, Cloneable, Comparable<TJobReq> {
  ...
  public TJobReq setClassName(String className) {
    this.className = className;
    return this;
  }
  ...
  public TJobReq setParameter(String parameter) {
    this.parameter = parameter;
    return this;
  }
  ...
  public TJobReq setAccessToken(String accessToken) {
    this.accessToken = accessToken;
    return this;
  }
  ...
  public int compareTo(TJobReq other) {
    ...
    lastComparison = Boolean.valueOf(isSetRetryJobId()).compareTo(other.isSetRetryJobId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRetryJobId()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TJobReq(");
    boolean first = true;
